...
def test_board_finds_winning_move(xo_board):
    xo_board[0] = "X"
    xo_board[1] = "X"
    assert xo_board.find_winning_move("X") == 2


def test_board_fails_to_find_incomplete_pattern(xo_board):
    xo_board[0] = "X"
    xo_board[5] = "X"
    assert xo_board.find_winning_move("X") == -1


def test_board_fails_to_find_occupied_winning_move(xo_board):
    xo_board[0] = "X"
    xo_board[1] = "X"
    xo_board[2] = "O"
    assert xo_board.find_winning_move("X") == -1
...
def test_board_finds_blocking_move(xo_board):
    xo_board[0] = "X"
    xo_board[1] = "X"
    assert xo_board.find_blocking_move("O") == 2
